...
public class bankOfSheng extends Activity {
	// 控件
	private TextView tv_banksheng_title = null;
	private ListView lv_banksheng_banklist = null;
	//线程
	private shengThread updthread = null;
	//异常日志
	private final static String TAG = "Log_banksheng";
	// 省市的数组
	...
	// list
	private ArrayList<HashMap<String, Object>> shengList = new ArrayList<HashMap<String, Object>>();
...
//		setContentView(com.btten.calltaxi.R.layout.bankofsheng);
		setContentView(R.layout.bankofsheng);
//		setBackKeyListner(backListener);
	...
	private void findViews() {
		tv_banksheng_title = (TextView) findViewById(R.id.tvId_banksheng_title);
		lv_banksheng_banklist = (ListView) findViewById(R.id.lvId_banksheng_banklist);
	}
	...
	private void setBankList() {
		SimpleAdapter adapter = new SimpleAdapter(this, shengList,
				R.layout.bankitem, new String[] { "shengname" }, 
				new int[] { R.id.tvId_bankitem_item });

		// SimpleAdapter adapter = new SimpleAdapter(this, dirList,
		// R.layout.shujiastyle, new String[] {
		// "dirname","dirtime","dirisdownoad" }, new int[] {
		// R.id.tvId_shujiastyle_index,
		// R.id.tvId_shujiastyle_bookname, R.id.tvId_shujiastyle_zuozhe });

		lv_banksheng_banklist.setAdapter(adapter);

		lv_banksheng_banklist
				.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
						...
						// TODO Auto-generated method stub
						// 显示对应的章节
						System.out.println("点中省或直辖市 :" + shengList.get(arg2).get("shengqyid").toString());
						Intent intent = new Intent();
						Bundle bundle = new Bundle();
						intent.setClass(bankOfSheng.this, bankOfShi.class);
						// send Mes to other view
						bundle.putString("KEY_SHENGQYID", shengList.get(arg2).get("shengqyid").toString());
...
//		System.out.println("所有省市的个数为："+ allCount);
		...
		for (int i = 0; i < allCount; i++) {
			if(str_shengname[i][2].equals("0"))
			{
				HashMap<String, Object> map = new HashMap<String, Object>();
				map.put("shengqyid", str_shengname[i][0]);
				map.put("shengname", str_shengname[i][1]);
